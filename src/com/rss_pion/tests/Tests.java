...
public class Tests extends Application {
	...
	public static final Article flux_1_article_3 = new Article(1l, true,
			...
			"flux_1_article_3_category", "flux_1_article_3_comments",
			Tests.flux_1_article_3_enclosure, Tests.flux_1_article_3_guid,
			"flux_1_article_3_pubDate", "flux_1_article_3_source", 1);
	...
	public static final Article flux_1_article_2 = new Article(1l, true,
			...
			"flux_1_article_2_category", "flux_1_article_2_comments",
			Tests.flux_1_article_2_enclosure, Tests.flux_1_article_2_guid,
			"flux_1_article_2_pubDate", "flux_1_article_2_source", 1);
	...
	public static final Article flux_1_article_1 = new Article(1l, true,
			...
			"flux_1_article_1_category", "flux_1_article_1_comments",
			Tests.flux_1_article_1_enclosure, Tests.flux_1_article_1_guid,
			"flux_1_article_1_pubDate", "flux_1_article_1_source", 1);
	...
	public static final Flux flux_1 = new Flux("flux_1_feed", "flux_1_title",
			...
			"flux_1_pubDate", "flux_1_lastBuildDate", "flux_1_category",
			"flux_1_generator", "flux_1_docs", Tests.flux_1_cloud, 1,
			Tests.flux_1_image, "flux_1_rating", Tests.flux_1_textInput,
			Tests.flux_1_skipHours, Tests.flux_1_skipDays, 1, 1, 1,
			Arrays.asList(new Article[] { Tests.flux_1_article_1,
					Tests.flux_1_article_2, Tests.flux_1_article_3 }));
	...
	public static final Article flux_2_article_3 = new Article(1l, true,
			...
			"flux_2_article_3_category", "flux_2_article_3_comments",
	...
	public static final Article flux_2_article_2 = new Article(1l, true,
			...
			"flux_2_article_2_category", "flux_2_article_2_comments",
	...
	public static final Article flux_2_article_1 = new Article(1l, true,
			...
			"flux_2_article_1_category", "flux_2_article_1_comments",
	...
	public static final Flux flux_2 = new Flux("flux_2_feed", "flux_2_title",
			...
			"flux_2_pubDate", "flux_2_lastBuildDate", "flux_2_category",
