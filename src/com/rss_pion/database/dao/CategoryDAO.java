...
/*** ATTRIBUTES ***************************************************************/
    ...
    //! Table
    public static String nameOfTheAssociatedTable = "";
 ...
 * 
 * @return  Liste de catégories ou null
 ******************************************************************************/
 ...
 * 
 * @return      Catégorie obtenu ou null
 ******************************************************************************/
    public static Category getCategoryFromDB(final Long id) {
        ...
        return getCategoriesFromDB(c).get(0);
    }
